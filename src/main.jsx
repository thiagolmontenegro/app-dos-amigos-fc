...
function AppDosAmigosFC() {
  ...
  async function changeFirstPassword() {
    if (!newPassword || newPassword.length < 6) {
      return setAuthMsg("A nova senha precisa ter pelo menos 6 caracteres.");
    }
    ...
    setNewPassword("");
    setAuthMsg("");
    notifyListChange("Senha alterada com sucesso.");
  }
